        ...
        from() {
            return {
                select() {
                    ...
                    // Make builder thenable so awaiting select() works
                    builder.then = function (resolve) { return Promise.resolve({ data: [], error: null }).then(resolve); };
                    builder.catch = function () { return Promise.resolve({ data: [], error: null }); };
